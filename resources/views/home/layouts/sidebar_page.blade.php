...
<ul class="list-group nav-bar">
    ...
    <div class="w3-sidebar w3-light-grey w3-bar-block " style="width:18%">
            ...
            <h4 class="w3-bar-item" style="color:#e63900"><b>Thông tin tài khoản</b></h4>
            ...
            <h4 class="w3-bar-item" style="color:#e63900"><b>Quản lý</b></h4>
            ...
            <h4 class="w3-bar-item" style="color:#e63900"><b>Phiên hỏi đáp</b></h4> 
